...
class CountryGeographySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['iso3', 'maps', 'total_area_sq_km', 'land_area_sq_km', 'water_area_sq_km', 'coastline_length_km']
...
class CountryEconomySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['iso3', 'gdp_real', 'gdp_gross', 'gdp_agriculture', 'gdp_industry', 'gdp_services',
...
class CountrySocietySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['iso3', 'languages', 'population', 'population_growth_rate', 'population_0_14_percentage',
